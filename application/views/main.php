...
<html lang="en">
    <head>
        <title>DOS 2018_19.2</title>
        <link rel="icon" type="image/ico" href="http://malikseeds.com/favicon.ico"/>
        <meta charset="utf-8">
        <link rel="stylesheet" href="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('css/bootstrap.min.css'));?>">
        <link rel="stylesheet" href="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('css/style.css?version='.time()));?>">
        <link rel="stylesheet" href="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('css/jquery-ui/jquery-ui.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('css/jquery-ui/jquery-ui.theme.css')); ?>">

        <link rel="stylesheet" href="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('css/jqx/jqx.base.css')); ?>">
        <style>
            .navbar-nav > li {
    ...
    <body>
        <script src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jquery-2.1.1.js')); ?>"></script>
        <script src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/bootstrap.min.js')); ?>"></script>
        <script src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/bootstrap-filestyle.min.js')); ?>"></script>
        <script src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jquery-ui.min.js')); ?>"></script>

        <!--    for jqx grid finish-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxcore.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxscrollbar.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.edit.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.sort.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.pager.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxbuttons.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxcheckbox.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxlistbox.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxdropdownlist.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxmenu.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.filter.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.selection.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.columnsresize.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxdata.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxdatatable.js')); ?>"></script>
        <!--    only for color picker-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxcolorpicker.js')); ?>"></script>
        <!--    For column reorder-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.columnsreorder.js')); ?>"></script>
        <!--    For print-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxdata.export.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.export.js')); ?>"></script>
        <!--        for footer sum-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxgrid.aggregates.js')); ?>"></script>
        <!-- for header tool tip-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxtooltip.js')); ?>"></script>
        <!-- popup-->
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/jqx/jqxwindow.js')); ?>"></script>
        ...
        <header class="hidden-print">
            ...
            <img alt="Logo" height="40" class="site_logo pull-left" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('images/logo.png'));?>">
        ...
        <div id="system_loading"><img src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('images/spinner.gif'));?>"></div>
        ...
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/system_common.js?version=<?php echo time(); ?>')); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/system_triggers.js?version=<?php echo time(); ?> ?>')); ?>"></script>
    </body>
</html>
