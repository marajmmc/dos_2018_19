...
<html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/system_common.js?version='.time())); ?>"></script>
        <script type="text/javascript" src="<?php echo str_replace('dos_2018_19','login_2018_19',base_url('js/system_triggers.js?version='.time())); ?>"></script>
    </body>
</html>
